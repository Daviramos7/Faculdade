...
def calcular_medias(pessoas):
    ...
    total_altura = sum(pessoa[3] for pessoa in pessoas)
    qtd_pessoas = len(pessoas)

    media_salario = total_salarios / qtd_pessoas
    media_peso = total_pesos / qtd_pessoas
    media_altura = total_altura / qtd_pessoas
    
    return(media_salario, media_peso, media_altura)
...
def main():
    ...
    media_salario, media_peso, media_altura = calcular_medias(pessoas)
    ...
    print(f"A média de altura das três pessoas é: {media_altura:.2f}")
